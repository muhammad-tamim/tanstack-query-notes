...
- [HTTP Operations (CRUD):](#http-operations-crud)
    ...
    - [Example 2:](#example-2)
- [Others:](#others)
  - [Installing Tanstack query devtools:](#installing-tanstack-query-devtools)
...
# Others: 
## Installing Tanstack query devtools: 
- 1st: install tanstack query extension on browser: 

![alt text](./assets/images/tanstack-query-extension.png)

- 2nd: Install and Import the Devtools on project: 
...
![alt text](./assets/images/tanstack-query-devtool-output.png)
